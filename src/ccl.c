...
//        ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/X_n.txt",dim_x,dim_n,X);
//        double *Y = malloc(dim_x*dim_n*sizeof(double));
//        ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/Y_n.txt",dim_y,dim_n,Y);
...
//        ccl_learn_ncl(X,Y,dim_x,dim_y,dim_n,dim_b,&model);
//        free(X);
//        free(Y);
        ...
        int dim_n = 1000;
        double *X = malloc(dim_x*dim_n*sizeof(double));
        ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/X_l_p.txt",dim_x,dim_n,X);
        double *Y = malloc(dim_x*dim_n*sizeof(double));
        ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/Y_l_p.txt",dim_y,dim_n,Y);
...
//    int i;
//    double *X = malloc(dim_x*dim_n*sizeof(double));
//    ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/X_pi.txt",dim_x,dim_n,X);
//    double *Y = malloc(dim_x*dim_n*sizeof(double));
//    ccl_read_data_from_file("/home/yuchen/Desktop/ccl-1.1.0/data/Y_pi.txt",dim_y,dim_n,Y);
//    //  prepare for BX
//    gsl_matrix X_ = gsl_matrix_view_array(X,dim_x,dim_n).matrix;
//    gsl_matrix Y_ = gsl_matrix_view_array(Y,dim_y,dim_n).matrix;
...
//    ccl_write_lwmodel_to_file("/home/yuchen/Desktop/ccl-1.1.0/data/learn_lwpi_model.txt", &model);
